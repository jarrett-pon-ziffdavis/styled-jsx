...
> Snapshot 1
    ...
    export default (() => {␊
      ...
      return <div className={"jsx-2886504620"}>␊
          ...
          <_JSXStyle id={"2886504620"}>{"div.jsx-2886504620.jsx-2886504620{color:red;}"}</_JSXStyle>␊
        </div>;␊
    });`
...
> Snapshot 1
    ...
    export const Test2 = () => <div className={"jsx-2982525546 " + \`jsx-${styles.__hash}\`}>␊
        ...
        <_JSXStyle id={"2982525546"}>{"p.jsx-2982525546.jsx-2982525546{color:red;}"}</_JSXStyle>␊
        <_JSXStyle id={styles.__hash}>{styles}</_JSXStyle>␊
    ...
    export const Test3 = ({␊
      color␊
        ...
        <_JSXStyle id={"1947484460"} dynamic={[color]}>{\`p.__jsx-style-dynamic-selector.__jsx-style-dynamic-selector{color:${color};}\`}</_JSXStyle>␊
        <_JSXStyle id={styles.__hash}>{styles}</_JSXStyle>␊
    ...
    export const Test4 = ({␊
      color␊
        ...
        <_JSXStyle id={"3190985107"}>{"p.jsx-3190985107.jsx-3190985107{display:inline-block;}"}</_JSXStyle>␊
        <_JSXStyle id={"1336444426"} dynamic={[color]}>{\`p.__jsx-style-dynamic-selector.__jsx-style-dynamic-selector{color:${color};}\`}</_JSXStyle>␊
        <_JSXStyle id={styles.__hash}>{styles}</_JSXStyle>␊
      </div>; // static only␊
    ␊
    export const Test5 = () => <div className={"jsx-1372669040"}>␊
        <p className={"jsx-1372669040"}>static only</p>␊
        <_JSXStyle id={"3190985107"}>{"p.jsx-1372669040.jsx-1372669040{display:inline-block;}"}</_JSXStyle>␊
        <_JSXStyle id={"2982525546"}>{"p.jsx-1372669040.jsx-1372669040{color:red;}"}</_JSXStyle>␊
    ...
    export const Test8 = ({␊
      ...
      if (color) {␊
        ...
        return <div className={_JSXStyle.dynamic([["1791723528", [innerProps.color]]])}>␊
            ...
            <_JSXStyle id={"1791723528"} dynamic={[innerProps.color]}>{\`p.__jsx-style-dynamic-selector.__jsx-style-dynamic-selector{color:${innerProps.color};}\`}</_JSXStyle>␊
          </div>;␊
      }␊
    ...
    export const Test9 = ({␊
      ...
      return <div className={_JSXStyle.dynamic([["248922593", [innerProps.color]]])}>␊
          ...
          <_JSXStyle id={"248922593"} dynamic={[innerProps.color]}>{\`p.__jsx-style-dynamic-selector.__jsx-style-dynamic-selector{color:${innerProps.color};}\`}</_JSXStyle>␊
        </div>;␊
    };␊
    ...
    export const Test10 = () => <div className={"jsx-461505126"}>␊
        ...
        <_JSXStyle id={"461505126"}>{\`p.jsx-461505126.jsx-461505126{color:${foo};}\`}</_JSXStyle>␊
    ...
    export const Test11 = ({␊
      ...
      const items = Array.from({␊
        length: 5␊
          ...
          <_JSXStyle id={"2172653867"} dynamic={[color]}>{\`.item.__jsx-style-dynamic-selector.__jsx-style-dynamic-selector{color:${color};}\`}</_JSXStyle>␊
          Item #{i + 1}␊
        </li>);␊
