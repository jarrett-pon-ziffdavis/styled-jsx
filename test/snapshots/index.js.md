...
> Snapshot 1
    ...
    ␊
        return <div className={_JSXStyle.dynamic([["1028791522", [_this.props.color]]])}>␊
            ...
            <_JSXStyle id={"1028791522"} dynamic={[_this.props.color]}>{\`div.__jsx-style-dynamic-selector.__jsx-style-dynamic-selector{background:${this.props.color};}\`}</_JSXStyle>␊
          </div>;␊
      }␊
    ␊
    }`
...
> Snapshot 1
    ...
    export default (() => <div className={"jsx-2743241663"}>␊
        ...
        <p className={"jsx-2743241663"}>woot</p>␊
        <_JSXStyle id={"2743241663"}>{"p.jsx-2743241663.jsx-2743241663{color:red;}"}</_JSXStyle>␊
      </div>);`
...
> Snapshot 1
    ...
    export default (() => <>␊
        ...
        <_JSXStyle id={"1712488456"}>{"p.jsx-1712488456.jsx-1712488456{color:cyan;}.foo.jsx-1712488456.jsx-1712488456{font-size:18px;color:hotpink;}#head.jsx-1712488456.jsx-1712488456{-webkit-text-decoration:underline;text-decoration:underline;}"}</_JSXStyle>␊
      </>);␊
    ␊
    function Component1() {␊
      return <>␊
    ...
    function Component2() {␊
      return <div className={"jsx-4156136654"}>␊
          <_JSXStyle id={"4156136654"}>{"div.jsx-4156136654.jsx-4156136654{color:red;}"}</_JSXStyle>␊
        </div>;␊
    }`
    ...
    export default class {␊
      render() {␊
        return <div className={"jsx-2101845350"}>␊
            ...
            <_JSXStyle id={"2101845350"}>{"p.jsx-2101845350.jsx-2101845350{color:red;}"}</_JSXStyle>␊
          </div>;␊
      }␊
    ␊
    }`
...
> Snapshot 1
    ...
    const Test = () => <div className={"jsx-2381107078"}>␊
        <_JSXStyle id={"2381107078"}>{"{color:red;}{color:red;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-animation:foo 1s ease-out;animation:foo 1s ease-out;}{display:none;}{color:red;}"}</_JSXStyle>␊
      </div>;␊
    ␊
    const Test2 = () => <_JSXStyle id={"2743241663"}>{"{color:red;}"}</_JSXStyle>;`
...
> Snapshot 1
    ...
    `import _JSXStyle from "styled-jsx/style";␊
    ␊
    const Test = () => <_JSXStyle id={"2743241663"}>{"{color:red;}"}</_JSXStyle>;␊
    ␊
    export default (() => <div className={"jsx-3467702132"}>␊
        <p className={"jsx-3467702132"}>test</p>␊
        <_JSXStyle id={"1061615554"}>{"{background:red;}"}</_JSXStyle>␊
        <_JSXStyle id={"2743241663"}>{"p.jsx-3467702132.jsx-3467702132{color:red;}"}</_JSXStyle>␊
      </div>);`
...
> Snapshot 1
    ...
    const Test1 = () => <div className={"jsx-2529315885"}>␊
        ...
        <Component />␊
        <_JSXStyle id={"2529315885"}>{"span.jsx-2529315885.jsx-2529315885{color:red;}"}</_JSXStyle>␊
      </div>;␊
    ␊
...
> Snapshot 1
    ...
    export default (({␊
      display␊
        ...
        <_JSXStyle id={"1003380713"}>{\`p.${color}.jsx-3956171631.jsx-3956171631{color:${otherColor};display:${obj.display};}\`}</_JSXStyle>␊
        <_JSXStyle id={"2743241663"}>{"p.jsx-3956171631.jsx-3956171631{color:red;}"}</_JSXStyle>␊
        <_JSXStyle id={"602592955"}>{\`{background:${color};}\`}</_JSXStyle>␊
        <_JSXStyle id={"602592955"}>{\`{background:${color};}\`}</_JSXStyle>␊
        <_JSXStyle id={"128557999"}>{\`p.jsx-3956171631.jsx-3956171631{color:${color};}\`}</_JSXStyle>␊
        <_JSXStyle id={"128557999"}>{\`p.jsx-3956171631.jsx-3956171631{color:${color};}\`}</_JSXStyle>␊
        <_JSXStyle id={"2143443147"} dynamic={[darken(color)]}>{\`p.__jsx-style-dynamic-selector.__jsx-style-dynamic-selector{color:${darken(color)};}\`}</_JSXStyle>␊
        <_JSXStyle id={"2381675492"} dynamic={[darken(color) + 2]}>{\`p.__jsx-style-dynamic-selector.__jsx-style-dynamic-selector{color:${darken(color) + 2};}\`}</_JSXStyle>␊
        <_JSXStyle id={"309852217"}>{\`@media (min-width: ${mediumScreen}){p.jsx-3956171631.jsx-3956171631{color:green;}p.jsx-3956171631.jsx-3956171631{color:${\`red\`};}}p.jsx-3956171631.jsx-3956171631{color:red;}\`}</_JSXStyle>␊
        <_JSXStyle id={"2824547816"}>{\`p.jsx-3956171631.jsx-3956171631{-webkit-animation-duration:${animationDuration};animation-duration:${animationDuration};}\`}</_JSXStyle>␊
        <_JSXStyle id={"417951176"}>{\`p.jsx-3956171631.jsx-3956171631{-webkit-animation:${animationDuration} forwards ${animationName};animation:${animationDuration} forwards ${animationName};}div.jsx-3956171631.jsx-3956171631{background:${color};}\`}</_JSXStyle>␊
    ␊
        <_JSXStyle id={"3830663176"} dynamic={[display ? 'block' : 'none']}>{\`span.__jsx-style-dynamic-selector.__jsx-style-dynamic-selector{display:${display ? 'block' : 'none'};}\`}</_JSXStyle>␊
        <_JSXStyle id={"1555166447"} dynamic={[display ? 'block' : 'none']}>{\`span.__jsx-style-dynamic-selector:before.__jsx-style-dynamic-selector{display:${display ? 'block' : 'none'};content:'\\\`';}\`}</_JSXStyle>␊
      </div>);`
...
> Snapshot 1
    ...
    const A = () => <div className={"jsx-128557999"}>␊
        ...
        <_JSXStyle id={"128557999"}>{\`p.jsx-128557999.jsx-128557999{color:${color};}\`}</_JSXStyle>␊
      </div>;␊
    ␊
    const B = () => <div className={"jsx-347939761"}>␊
        <p className={"jsx-347939761"}>test</p>␊
        <_JSXStyle id={"347939761"}>{\`p.jsx-347939761.jsx-347939761{color:${otherColor};}\`}</_JSXStyle>␊
      </div>;␊
    ␊
    export default (() => <div>␊
        <A />␊
...
> Snapshot 1
    ...
    const styles = new String("p.jsx-2587355013.jsx-2587355013{color:red;}");␊
...
> Snapshot 1
    ...
    export default (({␊
      ...
      return <Element className={"jsx-1253978709" + " " + "root"}>␊
          ...
          <_JSXStyle id={"1253978709"}>{".root.jsx-1253978709.jsx-1253978709{background:red;}"}</_JSXStyle>␊
        </Element>;␊
    });␊
    ...
    export default class {␊
      render() {␊
        ...
        return <Element className={"jsx-1800172487" + " " + "root"}>␊
            ...
            <_JSXStyle id={"1800172487"}>{".root.jsx-1800172487.jsx-1800172487{background:red;}"}</_JSXStyle>␊
          </Element>;␊
      }␊
    ␊
    }␊
...
> Snapshot 1
    ...
    export default function () {␊
      return <div className={"jsx-319553417"}>␊
          ...
          <_JSXStyle2 id={"319553417"}>{"p.jsx-319553417.jsx-319553417{color:red;}"}</_JSXStyle2>␊
        </div>;␊
    }`
...
> Snapshot 1
    ...
    ␊
    module.exports = () => <p className={"jsx-3800097675"}><_style.default id={"3800097675"}>{"p.jsx-3800097675.jsx-3800097675{color:red;}"}</_style.default></p>;`
