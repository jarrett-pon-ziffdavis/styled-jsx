...
test('splits rules for `optimizeForSpeed`', t => {
  ...
  assert('div { color: red }', ['{color:red;}'])
  ...
  assert(
    ...
    ['@media (min-width: 400px){{color:red;}}', '{color:red;}']
  )

  assert(
    '@media (min-width: 400px) { div { color: red } span { color: red } } a > .p { color: red }',
    ['@media (min-width: 400px){{color:red;}{color:red;}}', '{color:red;}']
  )
  ...
  assert(
    ...
    [`@media (min-width: 1px) and (max-width: 768px){{color:red;}}`]
  )
  ...
  `,
    [
      '@supports (display: flex){{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;}}'
    ]
  )
  ...
  `,
    [
      ...
      '@container (min-width: 400px){{color:red;}}'
    ]
  )
  ...
  `,
    [
      'div.jsx-123.jsx-123{-webkit-animation:fade-in ease-in 1;animation:fade-in ease-in 1;-webkit-animation-fill-mode:forwards;animation-fill-mode:forwards;-webkit-animation-duration:500ms;animation-duration:500ms;opacity:0;}',
  ...
  `,
    [
      '{-webkit-animation:fade-in ease-in 1;animation:fade-in ease-in 1;-webkit-animation-fill-mode:forwards;animation-fill-mode:forwards;-webkit-animation-duration:500ms;animation-duration:500ms;opacity:0;}',
      '@-webkit-keyframes fade-in{from{opacity:0;}to{opacity:1;}}',
      '@keyframes fade-in{from{opacity:0;}to{opacity:1;}}'
    ]
  )
  ...
  assert(
    ...
    [
      'div.jsx-123.jsx-123{color:red;}',
      '::-webkit-input-placeholder.jsx-123{color:green;}',
      '::-moz-placeholder.jsx-123{color:green;}',
      ':-ms-input-placeholder.jsx-123{color:green;}',
      '::placeholder.jsx-123{color:green;}'
    ],
    '.jsx-123'
  )
})
